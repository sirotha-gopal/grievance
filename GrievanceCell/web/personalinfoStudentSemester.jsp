...
<div class="container">
	<div class="row">
		<h3 style="padding-left: 200px;"><a href="personalinfoStudent.jsp"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Semester</a></h3>		
	</div>
</div>
<hr>
...
<div class="container">
	<div style="padding-left: 200px;">
		<p style="padding-top:0px; font-size: 16px; color:#808080;">Changes to your semester will be reflected across your Account.</p>
	</div>
	<div class="row" style="padding-left: 200px;">
		<form>
			<div class="form-group inner-addon right-addon">
                            ...
                            <input type="text" class="form-control input-lg" readonly="readonly" value="<%=sem%>" style="padding:35px; width: 600px; background-color:white;">
                                    ...
                                    <form action="Updater.jsp" method="post">
					        			...
					        			<div class="form-group">
					        				...
					        				<input type="text" name="semester" placeholder="Enter Semester" class="form-control">
                                                                                <input type="hidden" name="update" value="semester">
					        			</div>
