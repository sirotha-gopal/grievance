...
<head>
	...
	<title>Student Issue Description View Page</title>
...
<div class="container">
    <form action="IssueClose.jsp" method="post">
			...
			<div class="col">
                            <input type="text" name="issueId" class="form-control" readonly="readonly" placeholder="ID" style="background-color: white;" value="<%=issueId%>">
			</div>
		</div><br>
			...
			<div class="col">
                            ...
                            <input type="hidden" name="request" value="studentPage"/>
			</div>
