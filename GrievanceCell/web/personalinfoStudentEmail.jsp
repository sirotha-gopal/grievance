...
<div class="container">
	<div class="row">
		<h3 style="padding-left: 200px;"><a href="personalinfoStudent.jsp"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Email</a></h3>		
	</div>
</div>
<hr>
...
<div class="container">
	<div style="padding-left: 200px;">
		<p style="padding-top:0px; font-size: 16px; color:#808080;">Changes to your email will be reflected across your Account.</p>
	</div>
		...
		<form>
			<div class="form-group inner-addon right-addon">
				...
				<a href="#" style="text-decoration:none;color: inherit;"><i><span class="glyphicon glyphicon-pencil" data-toggle="modal" data-target="#edit"></span></i></a>
                                ...
                                <input type="text" class="form-control input-lg" readonly="readonly" value="<%=email%>"style="padding:35px; width: 600px; background-color:white;">
                                    ...
                                    <form action="Updater.jsp" method="post">
					        			...
					        			<div class="form-group">
					        				...
					        				<input type="text" name="email" placeholder="Enter Email" class="form-control">
                                                                                <input type="text" name="update" value="email">
					        			</div>
